...
# with open('./decision_graph.pickle', 'rb') as handle2, open('./cdp_spectrums.pickle', 'rb') as handle3:
#     decision_graph = pickle.load(handle2)
...
# plt.savefig('mnist_dnn_units.png')
...
with open('./decision_graph2.pickle', 'rb') as handle2, open('./cdp_spectrums2.pickle', 'rb') as handle3:
    decision_graph = pickle.load(handle2)
    cdp_spectrums = pickle.load(handle3)
...
# with open('./decision_graph_cifar10.pickle', 'rb') as handle2, open('./cdp_spectrums_cifar10.pickle', 'rb') as handle3:
#     decision_graph = pickle.load(handle2)
#     cdp_spectrums = pickle.load(handle3)
