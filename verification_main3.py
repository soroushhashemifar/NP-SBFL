...
class Verification:
    ...
    def __init__(self, deepcp, test_loader, pickles_path):
        self.deepcp = deepcp
    ...
    def calculate_tests_ratio(self, faulty_paths_vector):
        ...
        for data, target in tqdm.tqdm(self.test_loader):
            ...
            # print(activation_mask[faulty_paths_vector.astype(bool)])
...
def verify_main2():
    ...
    verification = Verification(deepcp2, test_loader, "pickles/")
    verification.run()
