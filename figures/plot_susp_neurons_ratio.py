...
def save_susp_distributions_plot(metric_threshold_tuples, decision_graph, cdp_spectrums, layers_units, num_layers_to_explore, filename):
    num_neurons_per_layers = []
    for metric, metric_threshold in metric_threshold_tuples:
        scores = []
        ...
        fpl_detected_neurons = [(layer_index, neuron_index) for faulty_cdp in faulty_cdps for layer_index in range(num_layers_to_explore) for neuron_index in decision_graph[faulty_cdp][layer_index]]
...
metric_threshold_tuples = [("tarantula", 0.90), ("ochiai", 0.14), ("barinel", 0.043)]
num_layers_to_explore = 2
filename = 'Model_1_susp_distribution.png'
save_susp_distributions_plot(metric_threshold_tuples, decision_graph, cdp_spectrums, layers_units, num_layers_to_explore, filename)
...
metric_threshold_tuples = [("tarantula", 0.87), ("ochiai", 0.05), ("barinel", 0.01)]
num_layers_to_explore = 4
filename = 'Model_2_susp_distribution.png'
save_susp_distributions_plot(metric_threshold_tuples, decision_graph, cdp_spectrums, layers_units, num_layers_to_explore, filename)
...
metric_threshold_tuples = [("tarantula", 0.91), ("ochiai", 0.37), ("barinel", 0.38)]
num_layers_to_explore = 6
filename = 'Model_3_susp_distribution.png'
save_susp_distributions_plot(metric_threshold_tuples, decision_graph, cdp_spectrums, layers_units, num_layers_to_explore, filename)