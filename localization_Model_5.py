...
if __name__ == "__main__":
    ...
    model_5_synthsizer = SynthesizeV2(deepcp5.model_name, model, test_loader, pickles_path=deepcp5.path_to_save_pickles, output_path=os.path.join(deepcp5.path_to_save_pickles, "synth_v2"), num_iterations=5, learning_rate=0.02)
    ...
    report_common_neurons_SFLs(model_5_synthsizer, suspiciousness_threshold, 8)
    ...
    evaluation(deepcp5.model_name, "tarantula", model, model_5_synthsizer.output_path, parameters, suspiciousness_threshold=suspiciousness_threshold)
    verification.verify("tarantula", suspiciousness_threshold=suspiciousness_threshold, synth_dataset_path=model_5_synthsizer.output_path)

    model_5_synthsizer.run("ochiai", suspiciousness_threshold=suspiciousness_threshold)
    evaluation(deepcp5.model_name, "ochiai", model, model_5_synthsizer.output_path, parameters, suspiciousness_threshold=suspiciousness_threshold)
    verification.verify("ochiai", suspiciousness_threshold=suspiciousness_threshold, synth_dataset_path=model_5_synthsizer.output_path)

    model_5_synthsizer.run("barinel", suspiciousness_threshold=suspiciousness_threshold)
    evaluation(deepcp5.model_name, "barinel", model, model_5_synthsizer.output_path, parameters, suspiciousness_threshold=suspiciousness_threshold)
    verification.verify("barinel", suspiciousness_threshold=suspiciousness_threshold, synth_dataset_path=model_5_synthsizer.output_path)
