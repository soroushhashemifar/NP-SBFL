...
if __name__ == "__main__":
    ...
    model_1_synthsizer = Synthesize_DF(deepfault1.model_name, model, test_loader, pickles_path=deepfault1.path_to_save_pickles, output_path=os.path.join(deepfault1.path_to_save_pickles, "synth_v1"), step_size=1, distance=0.5)
